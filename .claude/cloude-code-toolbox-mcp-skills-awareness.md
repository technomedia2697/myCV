...
_Generated: 2026-04-25T00:11:25.769Z_
...
Workspace `mcp.json` _(folder: test)_

- **e:\pro-angelo\test\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\BR7\AppData\Roaming\Code\User\mcp.json** — _File missing_
